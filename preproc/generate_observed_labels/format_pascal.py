...
pp.add_argument('--load-path', type=str, default='/home/julioarroyo/research_Eli_and_Julio/single-positive-multi-label-julio/data/pascal/', help='Path to a directory containing a copy of the PASCAL dataset.')
pp.add_argument('--save-path', type=str, default='/home/julioarroyo/research_Eli_and_Julio/single-positive-multi-label-julio/data/pascal/', help='Path to output directory.')
args = pp.parse_args()
