...
pp.add_argument('--load-path', type=str, default='/media/julioarroyo/aspen/data/coco', help='Path to a directory containing a copy of the COCO dataset.')
pp.add_argument('--save-path', type=str, default='/home/julioarroyo/research_Eli_and_Julio/single-positive-multi-label-julio/data/coco', help='Path to output directory.')
args = pp.parse_args()
...
if __name__ == '__main__':
    ...
    for split in ['train', 'val']:
        ...
        # JULIO START
        meta['row_idx_to_im_id'][split] = {row_idx : im_id for (im_id, row_idx) in image_id_to_index.items()}
        # JULIO END
